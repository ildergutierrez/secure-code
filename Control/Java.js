...
const dataopciones = {
    ...
    language: {
        ...
        zeroRecords: "Ningún Codigo Java encontrado",
        info: "Mostrando de _START_ a _END_ de un total de _TOTAL_ registros",
        infoEmpty: "Ningún codigo Java encontrado",
...
const user = async () => {
    try {
        ...
        usuarios.forEach((user, index) => {
            ruta = 'presentar_descripcion.php?ruta=' + btoa(user.Acceso) + "&rt=" + btoa(user.id) + "&tipo=" + btoa("java");
            contenido += `
            <tr>
