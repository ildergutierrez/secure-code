...
<body>
    <div class=" container-fluid" style="padding: 0; ">
                ...
                <div class="modal-content">
                    <div class="modal-header" style="background: #6309C3;">
                        <h5 class="modal-title" style="color: #ffffff;">
                            <center><img src="img/icono.ico" alt="Logo" style="border-radius: 100%; width: 30%;"> &ensp; Iniciar Sesión</center>
                        </h5>
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style=" background: #e1e3f7; position: fixed; z-index: 100; width: 100%; padding: 0;">
                <div class="container-fluid" style="background: #060f63;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul style="color: #ffffff; font-size: 20px;" class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="paginas/python.php">Python</a></li>
                                    <li><a class="dropdown-item" href="paginas/Csharp.php">c#</a></li>
                                    <li><a class="dropdown-item" href="paginas/Java.php">Java</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="paginas/glosario.php">Glosario</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                        ...
                        <form class="d-flex">
                            <button style="color: #ffffff; font-size: 20px;" class="btn btn-outline-info" type="button" data-bs-toggle="modal" data-bs-target="#modal-iniciar-sesion">Iniciar sesión</button>
                        </form>
                    </div>
                </div>
            </nav>
            ...
            ">
                    ...
                    <div class="row" style="background: rgb(189, 165, 196)">
                        <div class="col-2 d-flex align-items-center justify-content-center">
                            <center>
                                <h2><strong><a href="paginas/Csharp.html" style="text-decoration: none; color: #000000;">C#</a></strong></h2>
                            </center>
                        </div>
                    ...
                    <div class="row" style="background: rgb(153, 192, 236)">
                        <div class="col-2 d-flex align-items-center justify-content-center">
                            <center>
                                <h2><strong><a href="paginas/python.html" style="text-decoration: none; color: #000000;">Python</a></strong></h2>
                            </center>
                        </div>
                        <div class="col-4 d-flex align-items-center justify-content-center">
                            <center>
                    ...
                    <div class="row" style="background: rgb(240, 218, 146)">
                        <div class="col-2 d-flex align-items-center justify-content-center">
                            <center>
                                <h2><strong><a href="paginas/Java.html" style="text-decoration: none; color: #000000;">Javas</a></strong></h2>
                            </center>
                        </div>
                        <div class="col-4 d-flex align-items-center justify-content-center">
                            <center>
                    ...
                    <p style="padding: 50px; font-size: 18px;">
                        Debes tener en cuenta que solo son guias para que usted como usuario se
                        apoye y amplie su conocimiento o alimente su curiosidad.
                        <br />
                    </p>
                    <hr>
                </div>
