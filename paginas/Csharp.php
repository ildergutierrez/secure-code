...
<body>
    <div class="container-fluid" style="padding: 0; ">
        ...
        <main>
            ...
            <br />
            <div class="container" style="background: #ffffff; border-radius: 15px; border-radius: 15px;">
                <br /><br />
                <div class="container" style="width: 90%;">
                    <center> <img src="../img/csharo-trabajos.jpg" alt="Python" width="100%" height="300em"
