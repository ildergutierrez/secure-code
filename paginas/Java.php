...
<body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="../php/login.php" method="post">
                        <input type="hidden" value="../paginas/Java.php" name="direccion">
        ...
        <div class="container-md" style="width: 80%;">
            <div class="container" style="background: #fff; border-radius: 15px">
                ...
                <div class="container" style="width: 90%">
                    <center>
                        <img src="../img/java-trabajo.png" alt="Python" width="100%" height="300em" style="border-radius: 15px" />
                    </center>
                </div>
                <br /><br />
                <div class="container-md" style="padding: 30px">
                    ...
                    descargados... <br /><br /><b>Nota: </b><i>Ten presente que si no conoces de programación es mejor que tengas un buen antivirus o no copiles los codigos, solo leelos.</i><br><br>
                </div>
    ...
    <script src="../Control/Java.js"></script>
