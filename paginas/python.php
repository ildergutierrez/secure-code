                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul style="color: #ffffff; font-size: 20px;" class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="glosario.php">Glosario</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
        ...
        <main>
            ...
            <div class="container" style="background: #fff; border-radius: 15px; border-radius: 15px;">
                ...
                <div class="container" style="width: 90%;">
                    <center> <img src="../img/technology-1283624_1920.jpg" alt="Python" width="100%" height="300em" style="border-radius: 15px;"> </center>
                </div> <br><br>
                <div class="container" style="padding: 30px;">
                    <strong>Python</strong> es un lenguaje de programación ampliamente
                    utilizado en las aplicaciones web, el desarrollo de software, la ciencia
                    de datos y el machine learning (ML). Los desarrolladores utilizan Python
                    porque es eficiente y fácil de aprender, además de que se puede ejecutar
