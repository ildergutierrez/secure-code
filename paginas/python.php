...
<body>
    ...
    <div class="container-md" style="width: 80%;">
      <div class="container" style="background: #fff; border-radius: 15px">
        ...
        <div class="container" style="width: 90%">
          <center>
            <img src="../img/technology-1283624_1920.jpg" alt="Python" width="100%" height="300em" style="border-radius: 15px" />
          </center>
        </div>
        <br /><br />
        <div class="container-md" style="padding: 30px">
          <strong>Python</strong> es un lenguaje de programación ampliamente
          utilizado en las aplicaciones web, el desarrollo de software, la
          ciencia de datos y el machine learning (ML). Los desarrolladores
          utilizan Python porque es eficiente y fácil de aprender, además de
          que se puede ejecutar en muchas plataformas diferentes.

          <br /><br /><strong>Codigos en Python</strong> listos para ser
          descargados... <br /><br />
          <b>Nota: </b><i>Ten presente que si no conoces de programación es mejor que tengas un buen antivirus o no copiles los codigos, solo leelos.</i><br><br>
        </div>
        <div class="container-md" style="width: 95%; background: rgb(153, 192, 236); padding: 25px; border-radius: 15px;">
          <div class="row">
            <div class="md">
  ...
  <script src="../Control/python.js"></script>
