    ...
    <div class="container-fluid" style="padding: 0; ">
        ...
        <main>
            ...
            <a href="https://www.paypal.com/donate/?hosted_button_id=G4MSNR6JU3PB2" target="_blank"><img
                    class="Donacion" src="../img/donacion paypal.png" alt="Donacion" title="Donación"
                    width="60px" /></a>
            ...
            <div class="container" style="background: #fff; border-radius: 15px; padding: 30px;">
                ...
                <div class="container" style="width: 80%;">
                   <center> <img src="../img/monitor-1307227_1920.jpg" alt="Glosario" width="100%" height="200em" style="border-radius: 15px; "></center>
                </div><br />
                <br /><strong>Algoritmo:</strong> Un conjunto de pasos definidos y
                ...
                <em> tipos comunes de programadores</em>
                <br>
                <br /><br />
        ...
        <footer>
            <div class="container" style="background: #000000; color:#ffffff; border-radius: 50px;">
                <p>
                    <br>
                    <center><img src="../img/ubicacion.png" alt="ubicacion" width="20px"> - Colombia &ensp; <img
