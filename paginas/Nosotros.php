...
<body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="../php/login.php" method="post">
                        <input type="hidden" value="../paginas/Nosotros.php" name="direccion">
    ...
    <main>
        ...
        <div class="container" style="width: 87%;">
            ...
            <br>
            <div class="container" style="background: #ffffff; border-radius: 50px; width: 80%;">
                <br>
                <div class="container">
                    <img src="../img/4.png" alt="" width="100%" style="border-radius: 15px;">
                </div>
                <center>
                    <h1>Nosotros</h1>
                </center>
                ...
                <p>
                    ...
                    <center>
                        <p>
                            Somos un grupo de estudiantes de la Universidad Popular del Cesar - Seccional Aguachica, que decidimos crear esta pagina
                            con el fin de ayudar a los estudiantes de la universidad y a cualquier persona que necesite
                    ...
                    <center>
                        <p>
                            Ofrecemos codigos de programacion en diferentes lenguajes, glosarios, y una seccion de contacto
                    ...
                    <center>
                        <p>
                            Puedes ayudarnos con una donacion, para que podamos mantener la pagina en funcionamiento y
                            seguir subiendo contenido. <br>Tambien puedes ayudarnos compartiendo la pagina con tus amigos y registrandote, subiendo cogigos y probando los actuales.
                        </p>
                    </center>
                    <br>
